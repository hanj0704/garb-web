...
public class TestController {
	...
	public View hanLLists(HttpServletRequest request, HttpServletResponse response, DataRequest dataReq)
			throws IOException {
	...
	public void testlist(HttpServletRequest request, HttpServletResponse response, DataRequest datareq)
			throws IOException {
	...
	public View gaehangList(HttpServletRequest request, HttpServletResponse response, DataRequest datareq)
			throws IOException {
...
//		}
	...
	public void testJson(HttpServletRequest req, HttpServletResponse res, DataRequest dat) throws Exception {
		...
		System.out.println(dat.getParameter("data"));
